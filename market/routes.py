    ...
    if request.method == "POST":
        ...
        if p_item_object:
            if current_user.can_purchase(p_item_object):
                ...
                flash(f'Unfortunately your budget is not sufficient to purchase { p_item_object.name }',category='danger')
...
def register_page():
    ...
    if form.validate_on_submit():
        ...
        login_user(user_to_create)  # this logs in user
...
def login_page():
    ...
    if form.validate_on_submit():
        ...
        if attempted_user and attempted_user.check_password_correction(attempted_password=form.password.data):
            login_user(attempted_user) #this logs in user
